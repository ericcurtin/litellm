...
pub fn resolve_provider(provider_name: &str) -> Result<Box<dyn Provider>, AppError> {
    match provider_name {
        "openai" | "openai_like" | "together_ai" | "groq" | "deepseek"
        | "fireworks_ai" | "mistral" | "openrouter" | "perplexity"
        | "anyscale" | "deepinfra" | "xai" | "nvidia_nim"
        | "cerebras" | "sambanova" | "ollama" | "vllm"
        | "lm_studio" | "huggingface" => Ok(Box::new(openai::OpenAIProvider::new())),
...
pub fn build_api_url(
    ...
    match provider_name {
        ...
        "azure" | "azure_ai" => {
            // Azure requires api_base; this is a fallback
            format!("https://YOUR_RESOURCE.openai.azure.com/openai/deployments/YOUR_DEPLOYMENT{}", endpoint)
        }
...
pub fn resolve_api_key(provider_name: &str, params: &LitellmParams) -> Option<String> {
