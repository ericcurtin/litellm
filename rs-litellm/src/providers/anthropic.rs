...
use crate::types::{
    ...
    ChatDelta, ChatMessage, ChunkChoice, EmbeddingRequest, EmbeddingResponse, Usage,
};
...
/// Translates between OpenAI chat completion format and Anthropic Messages API.
...
fn get_api_url(params: &LitellmParams) -> String {
